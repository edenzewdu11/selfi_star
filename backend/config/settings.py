...
_DATABASE_URL = config('DATABASE_URL', default='postgresql://neondb_owner:npg_U6oNsZYu0CdK@ep-snowy-union-amv5ptvv.c-5.us-east-1.aws.neon.tech/neondb?sslmode=require')
if _DATABASE_URL:
    DATABASES = {
